...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen w-full bg-gradient-to-br from-purple-50 via-white to-blue-50 p-4 flex items-center justify-center">
        ...
        <div className="relative backdrop-blur-xl bg-white/10 rounded-3xl shadow-xl p-8 space-y-6">
          ...
          <div className="flex justify-center mb-4">
            <svg width="80" height="80" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                d="M60 80C60 60 75 45 100 45C125 45 140 60 140 80V120C140 140 125 155 100 155C75 155 60 140 60 120V80Z"
                fill="#003876"/>
              <path
                d="M85 95C85 85 90 80 100 80C110 80 115 85 115 95V105C115 115 110 120 100 120C90 120 85 115 85 105V95Z"
                fill="white"/>
          ...
          <div className="text-center space-y-1">
            <h1 className="text-2xl font-bold text-gray-800">HI-FIVE</h1>
            <p className="text-sm text-gray-600">전국 대학생 바인더</p>
          </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/90 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-100 text-black"
                  required
                />
              </div>
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 bg-[#FF6B6B] hover:bg-[#FF5252] text-white rounded-xl transition-colors">
              로그인
            </button>
          </form>
            ...
            <div className="grid grid-cols-3 gap-4">
              <button className="p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <svg className="w-8 h-8 mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M12 3C6.477 3 2 6.477 2 12C2 17.523 6.477 21 12 21C17.523 21 22 17.523 22 12C22 6.477 17.523 3 12 3Z"
                    fill="#FEE500"/>
                  <path
                    d="M12 8.5C9.24 8.5 7 10.24 7 12.45C7 13.84 7.89 15.05 9.26 15.74V17.5L11.21 16.18C11.47 16.22 11.73 16.25 12 16.25C14.76 16.25 17 14.51 17 12.3C17 10.09 14.76 8.5 12 8.5Z"
                    fill="#000000"/>
                </svg>
              </button>
              <button className="p-3 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <svg className="w-6 h-6 mx-auto" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="8"
                        fontWeight="bold">
                    HUFS
                  </text>
                </svg>
